...
if (is_super_admin($user)) {
    redirect_to(app_url('depthead/users.php'));
}

flash_set('error', 'Account management has been moved to the Super Admin module.');
...
<head>
    ...
    <title>User Management | ITFA Enrollment System</title>
...
<div class="min-h-screen lg:grid lg:grid-cols-[280px_1fr]">
    ...
    <main class="p-4 sm:p-6 lg:p-8 bg-[radial-gradient(circle_at_top,_rgba(22,101,52,0.12),_rgba(241,245,249,0.86)_45%,_rgba(241,245,249,1)_78%)]">
        ...
        <header class="bg-white/90 backdrop-blur rounded-3xl border border-green-100 shadow-panel p-6 mb-6">
            ...
            <p class="text-slate-500 mt-2">Manage department head and class manager accounts used for class scheduling. Default password: <strong class="font-mono"><?= DEFAULT_PASSWORD ?></strong>.</p>
        </header>
